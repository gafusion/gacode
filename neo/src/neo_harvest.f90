...
!
! PURPOSE:
!  creates subroutines for neo input and ouptput parameters
!  to be sent to harvest
!---------------------------------------------------------
  ...
  subroutine neo_harvest_input
   ...
   subroutine neo_harvest_output
    ...
    implicit none
        ...
        ierr=set_harvest_payload_dbl(harvest_sendline,"neo_eflux_thCHi_out"//NUL,neo_eflux_thCHi_out)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_pflux_thHS_out"//NUL,neo_pflux_thHS_out,11)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_eflux_thHS_out"//NUL,neo_eflux_thHS_out,11)
        ierr=set_harvest_payload_dbl(harvest_sendline,"neo_jpar_thS_out"//NUL,neo_jpar_thS_out)
        ierr=set_harvest_payload_dbl(harvest_sendline,"neo_jpar_thK_out"//NUL,neo_jpar_thK_out)
        ierr=set_harvest_payload_dbl(harvest_sendline,"neo_jpar_thN_out"//NUL,neo_jpar_thN_out)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_pflux_dke_out"//NUL,neo_pflux_dke_out,11)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_efluxtot_dke_out"//NUL,neo_efluxtot_dke_out,11)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_efluxncv_dke_out"//NUL,neo_efluxncv_dke_out,11)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_mflux_dke_out"//NUL,neo_mflux_dke_out,11)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_vpol_dke_out"//NUL,neo_vpol_dke_out,11)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_vtor_dke_out"//NUL,neo_vtor_dke_out,11)
        ierr=set_harvest_payload_dbl(harvest_sendline,"neo_jpar_dke_out"//NUL,neo_jpar_dke_out)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_pflux_gv_out"//NUL,neo_pflux_gv_out,11)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_efluxtot_gv_out"//NUL,neo_efluxtot_gv_out,11)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_efluxncv_gv_out"//NUL,neo_efluxncv_gv_out,11)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_mflux_gv_out"//NUL,neo_mflux_gv_out,11)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_nclassvis_out"//NUL,neo_nclassvis_out,11)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_pflux_nclass_out"//NUL,neo_pflux_nclass_out,11)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_efluxtot_nclass_out"//NUL,neo_efluxtot_nclass_out,11)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_vpol_nclass_out"//NUL,neo_vpol_nclass_out,11)
        ierr=set_harvest_payload_dbl_array(harvest_sendline,"neo_vtor_nclass_out"//NUL,neo_vtor_nclass_out,11)
