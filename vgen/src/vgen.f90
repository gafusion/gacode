...
program vgen
  ...
  write(4,'(40(a12))') 'expro_rho(-)','ni1/ne(-)','log10(nuee)' ,'q(-)','rmin(-)','ti1/te(-)','NEO_CTC','NEO_CTD',&
 ...
 '1_over_LnC','zi1(zD)','zi2(zC)','ni1(nD)','ni2(nC)','jbsNEONN','jbsSAUNN','delta','kappa','skappa','sdelta'
